...
Puppet::Type.newtype(:sonar_plugin) do
  require 'timeout'

  @doc = "Sonarqube Plugin Install from maven repository."

  newproperty(:ensure) do
    desc <<-EOT
      May be one of three values: 'present', 'absent' or 'latest'.  When 'present' (the default)
